                        ...
                        <div class="skills layout-spacing ">
                            <div class="widget-content widget-content-area">
                                ...
                                <tbody>
                                   ...
                                   @foreach($users->subscribed_package->package->profilequestion as $value) 
                              <tr>
                                <td colspan="5">{{ $value->question }}</td>
                                @if($value->answers != null)
                                @foreach($value->answers as $ans)
                                <td colspan="5">{{ $ans->answer }}</td>
                                @endforeach
                                @else
                                <td></td>
                                @endif
